...
(cl:defmethod cl:initialize-instance :after ((m <DoDishesGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoDishesGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name first_actionlib_sample-msg:<DoDishesGoal> is deprecated: use first_actionlib_sample-msg:DoDishesGoal instead.")))

(cl:ensure-generic-function 'dishwasher_id-val :lambda-list '(m))
(cl:defmethod dishwasher_id-val ((m <DoDishesGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_actionlib_sample-msg:dishwasher_id-val is deprecated.  Use first_actionlib_sample-msg:dishwasher_id instead.")
  (dishwasher_id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DoDishesGoal>)))
  ...
  "first_actionlib_sample/DoDishesGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DoDishesGoal)))
  "Returns string type for a message object of type 'DoDishesGoal"
  "first_actionlib_sample/DoDishesGoal")
