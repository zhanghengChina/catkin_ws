...
(cl:defmethod cl:initialize-instance :after ((m <DoDishesFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoDishesFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name first_actionlib_sample-msg:<DoDishesFeedback> is deprecated: use first_actionlib_sample-msg:DoDishesFeedback instead.")))

(cl:ensure-generic-function 'percent_complete-val :lambda-list '(m))
(cl:defmethod percent_complete-val ((m <DoDishesFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_actionlib_sample-msg:percent_complete-val is deprecated.  Use first_actionlib_sample-msg:percent_complete instead.")
  (percent_complete m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DoDishesFeedback>)))
  ...
  "first_actionlib_sample/DoDishesFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DoDishesFeedback)))
  "Returns string type for a message object of type 'DoDishesFeedback"
  "first_actionlib_sample/DoDishesFeedback")
