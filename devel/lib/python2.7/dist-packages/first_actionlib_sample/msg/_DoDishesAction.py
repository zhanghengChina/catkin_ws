...
"""autogenerated by genpy from first_actionlib_sample/DoDishesAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import first_actionlib_sample.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class DoDishesAction(genpy.Message):
  _md5sum = "b8ba3ee4bfe7a36f82e649f339415b09"
  _type = "first_actionlib_sample/DoDishesAction"
...
"""
  ...
  _slot_types = ['first_actionlib_sample/DoDishesActionGoal','first_actionlib_sample/DoDishesActionResult','first_actionlib_sample/DoDishesActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = first_actionlib_sample.msg.DoDishesActionGoal()
      if self.action_result is None:
        self.action_result = first_actionlib_sample.msg.DoDishesActionResult()
      if self.action_feedback is None:
        self.action_feedback = first_actionlib_sample.msg.DoDishesActionFeedback()
    else:
      self.action_goal = first_actionlib_sample.msg.DoDishesActionGoal()
      self.action_result = first_actionlib_sample.msg.DoDishesActionResult()
      self.action_feedback = first_actionlib_sample.msg.DoDishesActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4I.pack(_x.action_result.result.toal_dishes_cleaned, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.toal_dishes_cleaned, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
